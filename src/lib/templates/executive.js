...
function nameBlock(data) {
  ...
  if (data.title) {
    paras.push(
      new Paragraph({
        children: [
          runText(data.title, {
            size: pt(T.sizes.subline),
            italics: true,
            color: T.color.subline
          })
        ],
        spacing: { after: sp(2) }
      })
  ...
  paras.push(
    new Paragraph({
      children: [
        runText(data.contact || '', {
          size: pt(T.sizes.contact),
          color: T.color.contact
        })
      ],
      spacing: { after: sp(8) },
      border: {
    ...
    new Paragraph({
      children: [
        runText(data.senderName || '', {
          size: pt(T.sizes.letterheadName),
          bold: true,
          color: T.color.name
        })
      ],
