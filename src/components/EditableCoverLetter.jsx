    ...
    <div className="flex-1 overflow-auto space-y-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-3">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            placeholder="Name"
            value={r.name || ''}
            onChange={(e) => set('recipient.name', e.target.value)}
          />
          <input
            className={input}
            placeholder="Title"
            value={r.title || ''}
            onChange={(e) => set('recipient.title', e.target.value)}
          />
          <input
            className={input}
            placeholder="Company"
            value={r.company || ''}
            onChange={(e) => set('recipient.company', e.target.value)}
          />
          <input
            className={input}
            placeholder="Location"
            value={r.location || ''}
            onChange={(e) => set('recipient.location', e.target.value)}
          />
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => set('closingParagraph', e.target.value)}
        />
      </div>
